...
sector-7g includes a scheduler component that runs as an independent service, enabling:
...
```mermaid
graph TB
    subgraph "sector-7g Architecture"
...
#### CLI Health Check
```bash
sector-7g health check --detailed
