...
sector-7g includes comprehensive health monitoring capabilities through both API endpoints and CLI commands.
...
sector-7g provides a built-in CLI for health monitoring:

### Basic Health Check
```bash
sector-7g health status
```

**Output:**
```
sector-7g - System Status: HEALTHY
...
### Detailed Health Check
```bash
sector-7g health status --detailed
```
